...
public class ImGuiImplBlaze3D {
    ...
    private boolean isReady() {
        return compiledRenderPipeline != null &&
                !compiledRenderPipeline.isClosed() &&
    ...
    public void newFrame(boolean clearFontTextures) {
        ...
        if (compiledRenderPipeline == null || compiledRenderPipeline.isClosed())
            compiledRenderPipeline = RenderSystem.getCompiledPipelineNullable(renderPipeline);
    ...
    public void renderDrawData(final ImDrawData drawData, final RenderPass renderPass) {
        ...
        if (vertexBuffer == null || indexBuffer == null) {
            LOGGER.error("ImGui vertex or index buffer is invalid!");
            return;
        }
