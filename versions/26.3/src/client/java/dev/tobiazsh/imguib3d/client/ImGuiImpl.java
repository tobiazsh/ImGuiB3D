...
public class ImGuiImpl extends ImGuiImplementation {
    ...
    public void draw(ImGuiDrawable imGuiDrawable) {
        ...
        if (ImGui.getIO().hasConfigFlags(ImGuiConfigFlags.ViewportsEnable)) {
            ...
            final long window = SDLVideo.SDL_GL_GetCurrentWindow();
            ImGui.updatePlatformWindows();
            ImGui.renderPlatformWindowsDefault();

            SDLVideo.SDL_GL_MakeCurrent(window, context); // Restore the original OpenGL context after rendering ImGui windows
        }
    }
